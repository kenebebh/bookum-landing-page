        ...
        <Container>
          <div className="mb-24 flex flex-col items-center justify-center gap-y-6 lg:mb-28">
            ...
            >
              ...
              creators, readers, and authors connect and discover more
              meaningful bookish conversations.
            </motion.p>
            <motion.div
              variants={{
            ...
            <div className="mb-12 flex flex-col items-center justify-center gap-y-6 lg:mb-24 lg:flex-row lg:gap-x-10">
              <div className="flex basis-1/2 flex-col items-center justify-center gap-y-6">
                ...
                <p className="pageParagraphs md:text-center lg:text-left">
                  ...
                  company that thrives on collaborating with visionary
                  individuals who are deeply dedicated to breathing life into
                  extraordinary stories and vibrant communities.
                </p>
                <p className="pageParagraphs md:text-center lg:text-left">
          ...
          <AnimateY staggerAmount={0.35}>
            <div className="mb-32 flex flex-col items-center justify-center gap-y-6 lg:flex-row-reverse lg:gap-x-10">
              <div className="flex basis-1/2 flex-col items-center justify-center gap-y-6">
                ...
                <p className="pageParagraphs md:text-center lg:text-left">
                  As important as a story is, a story doesn't become important
                  in this world without community. Community is the secret sauce
                  of the bookish world and Bookum, as a platform, wholeheartedly
